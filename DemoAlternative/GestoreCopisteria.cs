...
{
	public static class GestoreCopisteria
	{
		...
		public static bool Menu()
		{
            ...
            switch (scelta)
            {
				...
				case 1:
					...
					break;
				case 2:
                    Console.WriteLine("Inserire il numero di fotocopie da inserire");
				...
				case 3:
					...
					break;
				default:
                    Console.WriteLine("Inserisci la scelta corretta");
					scelta = 
					break;
        ...
        {
            Console.WriteLine($"Inserire {valoreDaInserire}");
        ...
        {
            Console.WriteLine("Inserisci 0 per riffiutare, qualsiasi altro numero per confermare");
